					...
					<tr>
						<td style="width:1%;">
							<select id='searchtype__matchinglisttypes' name='searchtype__matchinglisttypes' class='drop-down go-to-selected' data-baseurl='transaction' style='min-width: 50px;'>
								<?php echo get_option_list($this, 'matchinglisttypes', 'select', '', array('selected'=>'match_by_descriptor'));?>
							</select>
						</td>
						<td style="width:1%;">
						...
						<td style="width:96%;">
							...
							<input type='hidden' id='action' name='action' value='<?php echo base_url()."lists/load/t/descriptor_list/n/20";?>' />
						</td>
						<td style="width:1%;">
		...
		<tr>
			<td>
				...
				data-fields='searchbank__topbanks=bankId|searchstatus__matchstatus=status|searchadmins__admins=adminId|descriptorsearch=phrase'>
					...
					<?php $this->load->view('transaction/descriptor_list_container', array('descriptorList'=>$descriptorList));?>
				</div>
			</td>
		</tr>
	</table>
