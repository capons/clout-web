...
$cssList = array('external-fonts.css','clout.css','clout.list.css','clout.shadowpage.css', 'clout.shadowbox.css');
...
if(!empty($icon_url)) echo "<td class='expandable_image shadowbox closable' style='background: url(".$icon_url.") no-repeat center top; background-size: cover;' data-url='".base_url()."user/facebook_photos/d/".$owner_user_id."/t/facebook' >&nbsp;</td>";
