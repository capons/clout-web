...
<head>
	...
	<title><?php echo SITE_TITLE.": Affiliates";?></title>
...
$this->load->view('addons/vertical_menu', array('__page'=>'affiliate_admin', 'area'=>'administrator')); 
# Header content
$this->load->view('addons/header_admin', array('__page'=>'affiliate_admin', 'title'=>'Affiliates'));
...
<span class='h1'>Welcome to Affiliate Administration</span>
</div>
...
<?php echo minify_js('affiliate__home', array('jquery-2.1.1.min.js', 'bootstrap.min.js', 'jquery-ui.js', 'jquery.form.js', 'clout.js', 'clout.fileform.js', 'clout.menu.js'));?>
