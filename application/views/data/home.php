...
<head>
	...
	<title><?php echo SITE_TITLE.": Data Administration";?></title>
...
$this->load->view('addons/vertical_menu', array('__page'=>'data_admin', 'area'=>'administrator')); 
# Header content
$this->load->view('addons/header_admin', array('__page'=>'data_admin', 'title'=>'Data Administration'));
...
<span class='h1'>Welcome to Data Administration</span>
</div>
...
<?php echo minify_js('data__home', array('jquery-2.1.1.min.js', 'bootstrap.min.js', 'jquery-ui.js', 'jquery.form.js', 'clout.js', 'clout.fileform.js', 'clout.menu.js'));?>
