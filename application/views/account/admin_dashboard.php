...
<div id="page1" class="fill">
    ...
    <div class="navbar navbar-fixed-top">
        ...
        $this->load->view('addons/vertical_menu', array('__page'=>'dashboard', 'area'=>'administrator'));
        # Header content
        $this->load->view('addons/header_admin', array('__page'=>'dashboard', 'title'=>'Dashboard'));
        ?>
    </div>
    ...
    <div class="menu-gap" style="padding-left:20px;">
        <span class='h1'>Welcome to the Admin Dashboard</span>
    </div>
...
<?php echo minify_js('account__admin_dashboard', array('jquery-2.1.1.min.js', 'bootstrap.min.js', 'jquery-ui.js', 'jquery.form.js', 'clout.js', 'clout.fileform.js', 'clout.menu.js', 'clout.shadowbox.js', 'clout.search.js'));?>
