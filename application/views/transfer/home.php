...
<head>
    ...
    <title><?php echo SITE_TITLE.": Money Transfers";?></title>
...
$this->load->view('addons/vertical_menu', array('__page'=>'money_transfer_admin', 'area'=>'administrator')); 
# Header content
$this->load->view('addons/header_admin', array('__page'=>'money_transfer_admin', 'title'=>'Money Transfers'));
...
<span class='h1'>Welcome to Money Transfer Administration</span>
</div>
