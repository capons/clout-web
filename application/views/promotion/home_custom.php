...
<head>
	...
	type="text/css" media="screen">
	<link rel="stylesheet" href="<?php echo base_url();?>assets/css/clout.promotion.custom.css">
<!--  
	...
	<div id="page1" style="padding-top: 70px;">
		<div class="navbar navbar-fixed-top">
			...
			$this->load->view ( 'addons/header_admin', array (
				...
				?>
				<a  style="float: right; margin-right:20px;" href="javascript:;" onClick="location.href='<?php echo base_url();?>promotion/home'"><img src="../assets/images/score_view_inactive.png" width="55px" height="55px"  onmouseover="this.src='../assets/images/score_view_active.png'" onmouseout="this.src='../assets/images/score_view_inactive.png'"/></a>
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				<tr>
					<table width="100%" border="0" cellspacing="0" cellpadding="5">
						<tr>
							<td width="0%" style="padding-left: 20px;"><div
								class="bigscreendetails topleftheader" style="font-size: 22px;">Promotion
								Management by Custom Spend</div></td>
							</tr>
						</table>
					</tr>
						...
						<div class="main-content">
							<div class="content-wrap">
								<aside class="category-menu">
									<div class="category-title"><span>┌ If any are true, then:</span></div>
									<div class="category-list">
										
									</div>
									<div class="category-block add-category">
										<a href="#">add new</a>
										<section class="category">
											...
											<div class="sub-categories-wrap"></div>
											<button class="addCategory" type="submit">add</button>
								...
								<div class="level-content">
									...
									<div class="level-wrap">
										<input type="text" class="add-new-level" placeholder="Add custom Level">
										<div class="clearfix"></div>
									</div>
									<div class="clearfix"></div>
									<div class="details-window">
										...
										<div class="add-part">
											<div class="load-promotion-sircle"><img src="<?php echo base_url();?>assets/images/loading.gif" alt=""></div>
					...
					<?php echo minify_js('promotion__home_custom', array('jquery-2.1.1.min.js', 'bootstrap.min.js', 'jquery-ui.js', 'jquery.form.js', 'clout.js', 'clout.fileform.js', 'clout.menu.js'));?>
					<script src="http://code.jquery.com/jquery-1.10.2.js"></script>
					<script src="http://code.jquery.com/ui/1.10.4/jquery-ui.js"></script>
					<script src="<?php echo base_url();?>assets/js/config.js"></script>
					<script src="<?php echo base_url();?>assets/js/promotion.api.js"></script>
					<script src="<?php echo base_url();?>assets/js/clout.promotion.custom.js"></script>
					<script>
						$( function() {
							$( ".level-container" ).sortable();
							// $( ".level-container" ).disableSelection();
						} );
					</script>
