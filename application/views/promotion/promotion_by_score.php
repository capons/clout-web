...
<!-- Offer 1 -->
															<div id="offer_001" class="bottombordergrey" style="padding: 10px;">
																<table width="100%" border="0" cellspacing="0" cellpadding="5">
																	<tr>
																		<td width="3%">
																			<table border="0" cellspacing="0" cellpadding="2" class="rewardcardbig greenbg">
																				<tr>
																					<td class="toprow"></td>
																				</tr>
																				<tr>
																		...
																		<td align="left" class="pagesubtitle"
																			style="padding-top: 5px; text-align: left;">Cash Back<a href="javascript:;" onClick="updateFieldLayer('<?php echo base_url()."promotion/edit_offer/i/".encrypt_value('001');?>','','','containerdiv','')"><img style="margin-top:-5px;" src="../assets/images/edit_pencil.png" width="20px" height="20px"/></a><br>
																			<span class="opensansmedium">200+ points</span>
																		</td>
																		<td width="30%" align="left" class="opensansmedium"
																			nowrap>$14,021 gross sales during 21 days active</td>
																		<td width="1%" class="opensansmedium"
																			style="min-width: 200px;"><span class="green">active</span></td>
																		<td width="1%" style="min-width: 100px;"><input
																			type="button" name="pausebtn" id="pausebtn"
																			value="Pause" class="forrestgreenbtn"
															...
															<div id="offer_002" class="bottombordergrey"
																...
																<table width="100%" border="0" cellspacing="0"
																	...
																	<tr>
																		...
																		<td align="left" class="pagesubtitle"
																			style="padding-top: 5px; text-align: left;">Cash Back<a href="javascript:;" onClick="updateFieldLayer('<?php echo base_url()."promotion/edit_offer/i/".encrypt_value('002');?>','','','containerdiv','')"><img style="margin-top:-5px;" src="../assets/images/edit_pencil.png" width="20px" height="20px"/></a><br> <span
																			class="opensansmedium">Mon-Wed all day. Thur-Sun
																				10am-4pm. On all purchases</span>
																		</td>
																		<td align="left" class="opensansmedium" width="30%"
																			nowrap>$402 gross sales during 1 day active</td>
																		<td width="1%" class="opensansmedium"
																			style="min-width: 200px;"><span class="red">inactive</span></td>
																		<td width="1%" style="min-width: 100px;"><input
																			type="button" name="publishbtn" id="publishbtn"
																			value="Publish" class="bluebtn" style="width: 100px;"></td>
																	</tr>
																</table>
															</div>

															<!-- Offer 3 -->
															<div id="offer_003" class="bottombordergrey"
																style="padding: 10px;">
																<table width="100%" border="0" cellspacing="0"
																	cellpadding="5">
																	<tr>
																		...
																		<td align="left" class="pagesubtitle"
																			style="padding-top: 5px; text-align: left;">Cash Back<a href="javascript:;" onClick="updateFieldLayer('<?php echo base_url()."promotion/edit_offer/i/".encrypt_value('003');?>','','','containerdiv','')"><img style="margin-top:-5px;" src="../assets/images/edit_pencil.png" width="20px" height="20px"/></a><br> <span
																			class="opensansmedium">When you spend $100+. On all
																				purchases.</span>
																		</td>
																		<td align="left" class="opensansmedium" width="30%"
																			nowrap>$802 gross sales during 3 days active</td>
																		<td width="1%" class="opensansmedium"
																			style="min-width: 200px;"><span class="red">inactive</span></td>
																		<td width="1%" style="min-width: 100px;"><input
																			type="button" name="publishbtn" id="publishbtn"
															...
															<!-- Offer 4 -->
															<div id="offer_005" class="bottombordergrey"
																style="padding: 10px;">
																<table width="100%" border="0" cellspacing="0"
																	cellpadding="5">
																	<tr>
																		...
																		<td align="left" class="pagesubtitle"
																			...
																			Entrance<a href="javascript:;" onClick="updateFieldLayer('<?php echo base_url()."promotion/edit_offer/i/".encrypt_value('004');?>','','','containerdiv','')"><img style="margin-top:-5px;" src="../assets/images/edit_pencil.png" width="20px" height="20px"/></a><br> <span
																			class="opensansmedium">No cover charge and skip the line. Up to 5 guests.</span>
																		</td>
																		<td align="left" class="opensansmedium" width="30%"
															...
															<!-- START NEW PERK -->
															<div id="offer_new_perk" class="bottombordergrey" style="padding: 10px; cursor: pointer;" onClick="unhideShowLayer('offer_new_perk_edit','offer_new_perk')">
																<table width="100%" border="0" cellspacing="0" cellpadding="5">
																	<tr>
																		<!-- CARD -->
																		<td width="3%">
																			<table border="0" cellspacing="0" cellpadding="2" class="offercardbig">
																				<tr>
																					<td class="toprow"></td>
																				</tr>
																				<tr>
																		...
																		<!-- TITLE -->
																		<td align="left" class="pagesubtitle" style="padding-top: 5px; text-align: left; color: #c0c0c0">Create a new Perk!</td>
																	</tr>
																</table>
															</div>
