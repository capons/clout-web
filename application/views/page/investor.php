...
<body class="have-side-menu">
	...
	<!-- intro section -->
	<section id="welcome" class="intro" style="background-image: url('<?php echo base_url();?>assets/images/landing/investors.jpg')">
		<div class="">
      <?php # Header content
...
<script type="text/javascript" src="https://www.clout.com/assets/js/clout.googleanalytics.js"></script>
	<?php echo minify_js('page__investor', array('jquery.min.js', 'scrollr.min.js', 'clout.menu.js', 'app.js'));?>
