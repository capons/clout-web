...
<body class="have-side-menu">
	...
	<!-- intro section -->
	<section id="welcome" class="intro" style="background-image: url('<?php echo base_url();?>assets/images/landing/business-accounts.jpg')">
		<div class="">
      <?php # Header content
      ...
      <div class="wrapper fullheight">
				...
				<div class="intro__text">
					...
					<a href="<?php echo base_url();?>account/sign_up" class="btn__green"><?php echo $startBtnLabel?></a>
				</div>
