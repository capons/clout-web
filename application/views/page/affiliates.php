...
<body class="have-side-menu">
	...
	<!-- intro section -->
	<section id="welcome" class="intro" style="background-image: url('<?php echo base_url();?>assets/images/landing/affiliates_bg.jpg')">
		<div class="">
      <?php # Header content
				...
				<div class="intro-footer">
					<div class="table">
						<div class="table-cell">
							...
							<div class="intro-footer__text2"><?php echo $page1FooterTxt?></div>
						</div>
					</div>
				</div>
			</div>
  ...
  <?php $this->load->view('addons/footer_public'); ?>
	...
	<?php echo minify_js('page__affiliates', array('jquery.min.js', 'scrollr.min.js', 'clout.menu.js', 'app.js'));?>
