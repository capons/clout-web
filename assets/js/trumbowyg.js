...
/*******************************************************************************************************************
 * Library implemetation classes.
 * 
 * This part is customizable to meet system requirements.
 *******************************************************************************************************************/
...
function setHtmlFieldValue(fieldId, content)
{
	$('#'+fieldId).trumbowyg('html', "<p>"+content+"</p>");
}